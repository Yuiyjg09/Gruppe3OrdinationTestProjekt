...
public class ServiceTest {
	...
	private ArrayList<Patient> patients = (ArrayList<Patient>) service.getAllPatienter();
	private ArrayList<Laegemiddel> laegemiddels = (ArrayList<Laegemiddel>) service.getAllLaegemidler();
	...
	public void opretPNOrdinationtc1() {
		...
		service.opretPNOrdination(LocalDate.of(2018, 5, 20), LocalDate.of(2018, 5, 18), patient, laegemiddel, 2);
	...
	public void opretPNOrdinationtc2() {
		Patient patient = service.opretPatient("123456-7891", "Benny Bomstærk", 98.3);
		Laegemiddel laegemiddel = service.opretLaegemiddel("Anti-pistolskid", 1, 2, 3, "Stk.");
		service.opretPNOrdination(LocalDate.of(2018, 5, 20), LocalDate.of(2018, 5, 22), patient, laegemiddel, 0);
	...
	public void opretPNOrdinationtc3() {
		Patient patient = service.opretPatient("123456-7891", "Benny Bomstærk", 98.3);
		Laegemiddel laegemiddel = service.opretLaegemiddel("Anti-pistolskid", 1, 2, 3, "Stk.");
		service.opretPNOrdination(LocalDate.of(2018, 5, 20), LocalDate.of(2018, 5, 2), patient, laegemiddel, -1);
	...
	public void opretPNOrdinationtc4() {
		Patient patient = service.opretPatient("123456-7891", "Benny Bomstærk", 98.3);
		Laegemiddel laegemiddel = service.opretLaegemiddel("Anti-pistolskid", 1, 2, 3, "Stk.");
		service.opretPNOrdination(LocalDate.of(2018, 5, 20), LocalDate.of(2018, 5, 18), patient, laegemiddel, -1);
	...
	public void opretPNOrdinationtc5() {
		...
		assertTrue(patients.get(0).getOrdinationer().contains(pn));
	}
	...
	public void opretPNOrdinationtc6() {
		Patient patient = service.opretPatient("123456-7891", "Benny Bomstærk", 98.3);
		Laegemiddel laegemiddel = service.opretLaegemiddel("Anti-pistolskid", 1, 2, 3, "Stk.");
		service.opretPNOrdination(null, LocalDate.of(2018, 5, 22), patient, laegemiddel, 2);
	...
	public void opretPNOrdinationtc7() {
		Patient patient = service.opretPatient("123456-7891", "Benny Bomstærk", 98.3);
		Laegemiddel laegemiddel = service.opretLaegemiddel("Anti-pistolskid", 1, 2, 3, "Stk.");
		service.opretPNOrdination(LocalDate.of(2018, 5, 20), LocalDate.of(2018, 5, 22), null, laegemiddel, 2);
	...
	public void opretPNOrdinationtc8() {
		Patient patient = service.opretPatient("123456-7891", "Benny Bomstærk", 98.3);
		Laegemiddel laegemiddel = service.opretLaegemiddel("Anti-pistolskid", 1, 2, 3, "Stk.");
		service.opretPNOrdination(LocalDate.of(2018, 5, 20), LocalDate.of(2018, 5, 22), patient, null, 2);
