...
=======
	...
	/**
	 * Opretter og returnerer en DagligSkÊv ordination. Hvis startDato er efter
	 * slutDato kastes en IllegalArgumentException og ordinationen oprettes ikke.
	 * Hvis antallet af elementer i klokkeSlet og antalEnheder er forskellige kastes
	 * ogsÂ en IllegalArgumentException.
	 *
	 * Pre: startDen, slutDen, patient og laegemiddel er ikke null
	 */
	public DagligSkaev opretDagligSkaevOrdination(LocalDate startDen, LocalDate slutDen, Patient patient,
	...
	/**
	 * En dato for hvornÂr ordinationen anvendes tilf¯jes ordinationen. Hvis
	...
	/**
	 * Den anbefalede dosis for den pÂgÊldende patient (der skal tages hensyn til
	 * patientens vÊgt). Det er en forskellig enheds faktor der skal anvendes, og
	 * den er afhÊngig af patientens vÊgt. Pre: patient og lÊgemiddel er ikke
	 * null
	 */
	public double anbefaletDosisPrDoegn(Patient patient, Laegemiddel laegemiddel) {
		double result;
	...
	/**
	 * For et givent vÊgtinterval og et givent lÊgemiddel, hentes antallet af
	 * ordinationer. Pre: laegemiddel er ikke null
	 */
	public int antalOrdinationerPrVÊgtPrLÊgemiddel(double vÊgtStart, double vÊgtSlut, Laegemiddel laegemiddel) {
		int ordinationer = 0;
		for (Patient p : getAllPatienter()) {
			if (p.getVaegt() >= vÊgtStart && p.getVaegt() <= vÊgtSlut) {
