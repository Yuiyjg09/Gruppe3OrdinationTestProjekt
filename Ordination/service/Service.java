...
public class Service {
	 ...
	 */
	public PN opretPNOrdination(@NotNull LocalDate startDen, @NotNull LocalDate slutDen, @NotNull Patient patient,
			@NotNull Laegemiddel laegemiddel, @NotNull double antal) {
		// TODO
